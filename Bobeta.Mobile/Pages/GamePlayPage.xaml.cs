...
public partial class GamePlayPage : ContentPage, IQueryAttributable
{
    ...
    protected override async void OnAppearing()
    {
        ...
        NzengueBoard.MoveRequested += OnNzengueMoveRequested;
        YoteBoard.MoveRequested -= OnYoteMoveRequested;
        YoteBoard.MoveRequested += OnYoteMoveRequested;
    ...
    private void SyncUi()
    {
        ...
        var isYote = _vm.IsYote;
        var isMakopa = !isKopo && !isNgola && !isDomino && !isAbbia && !isNzengue && !isYote;
        ...
        YoteBoard.IsVisible = isYote && _vm.Yote != null;
        ...
        else if (isYote && _vm.Yote != null)
        {
            YoteBoard.State = _vm.Yote;
            YoteBoard.CanInteract = _vm.IsPlayerTurn && !_vm.ShowGameResult
                && !_vm.ShowInactivityOverlay && !_vm.IsSendingMove;
            RulesLink.IsVisible = true;
            RulesLink.Text = i18n.T("yote_rules_link");
            RoundScoreLabel.IsVisible = false;
        }
    ...
    private async void OnRulesTapped(object? sender, TappedEventArgs e)
    {
        ...
        else if (_vm?.IsYote == true)
            await DisplayAlertAsync(i18n.T("yote_how_to_play_title"), i18n.T("yote_rules_body"), i18n.T("done_short"));
        else
    ...
    private async void OnYoteMoveRequested(object? sender, (int? FromCell, int ToCell, int? ExtraRemoveCell) e)
    {
        if (_vm == null) return;
        await _vm.OnYoteMoveAsync(e.FromCell, e.ToCell, e.ExtraRemoveCell);
    }
}
