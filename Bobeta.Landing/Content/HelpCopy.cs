...
public static class HelpCopy
{
    ...
    [
        ...
        new("What games can I play?",
            "Makopa, Kopo, Ngola, Domino, and Abbia. Open a game on the home page and tap History for background. Each match is one-vs-one for a stake you choose."),
    ...
    [
        ...
        new("Quels jeux puis-je jouer ?",
            "Makopa, Kopo, Ngola, Domino et Abbia. Sur la page d'accueil, ouvrez un jeu et touchez Histoire pour le contexte. Chaque partie est un duel avec une mise que vous choisissez."),
    ...
    [
        ...
        new("Ba jeux nini nge lenda sakana?",
            "Makopa, Kopo, Ngola, Domino mpi Abbia. Na page ya liboso, fina Histoire sambu na histoire. Ketesani kele duel ti mise nge me solula."),
    ...
    [
        ...
        new("Ba jeux nini nakoki kosakana?",
            "Makopa, Kopo, Ngola, Domino mpe Abbia. Na lokasa ya liboso, finá Histoire mpo na historique. Mokano mokomoko ezali duel na mise oponi."),
    ...
    [
        ...
        new("Naweza kucheza michezo gani?",
            "Makopa, Kopo, Ngola, Domino, na Abbia. Kwenye ukurasa wa kwanza, gusa Historia kwa historia. Kila mechi ni pambano la mtu mmoja dhidi ya mwingine kwa dau unalochagua."),
