...
public static class HelpCopy
{
    ...
    [
        ...
        new("What happens to the pot when I win?",
            "Both players' stakes form the pot. Bobeta takes a platform fee (25%). The rest goes to the winner's wallet."),
    ...
    [
        ...
        new("Que devient le pot si je gagne ?",
            "Les mises des deux joueurs forment le pot. Bobeta prélève des frais de plateforme (25 %). Le reste va sur le portefeuille du gagnant."),
    ...
    [
        ...
        new("Soki nge me longa, pot ke kwenda wapi?",
            "Ba mises zole ke sala pot. Bobeta ke baka frais ya plateforme (25%). Ya ntama ke kwenda na wallet ya nani me longa."),
    ...
    [
        ...
        new("Soki nalóngi, pot ekendaka wapi?",
            "Ba mises mibale esalá pot. Bobeta ezwi frais ya plateforme (25%). Oyo etikali ekenda na wallet ya oyo elongi."),
    ...
    [
        ...
        new("Poti inaenda wapi nikishinda?",
            "Dau za wachezaji wote mbili huunda poti. Bobeta inachukua ada ya jukwaa (25%). Salio huenda kwenye pochi ya mshindi."),
    ...
    private static readonly LegalDoc TermsEn = new(
        ...
        [
            ...
            new("Matches and fees",
                "When you join a match, your stake is locked. The pot is both stakes combined. Bobeta takes a 25% platform fee from the pot. The winner receives the rest in their Bobeta wallet."),
            new("Fair play",
    ...
    private static readonly LegalDoc TermsFr = new(
        ...
        [
            ...
            new("Parties et frais",
                "Quand vous rejoignez une partie, votre mise est bloquée. Le pot = les deux mises. Bobeta prélève 25 % de frais sur le pot. Le gagnant reçoit le reste sur son portefeuille Bobeta."),
            new("Jeu loyal",
    ...
    private static readonly LegalDoc TermsKt = new(
        ...
        [
            ...
            new("Ba parties mpi ba frais",
                "Soki nge me kota partie, mise ke zibama. Pot = ba mises zole. Bobeta ke baka 25% ya pot. Nani me longa ke bakaka ya ntama na wallet."),
    ...
    private static readonly LegalDoc TermsLn = new(
        ...
        [
            ...
            new("Ba parties mpe ba frais",
                "Soki okoti partie, mise ezibani. Pot = ba mises mibale. Bobeta ezwi 25% ya pot. Oyo elongi azwi oyo etikali na wallet."),
    ...
    private static readonly LegalDoc TermsSw = new(
        ...
        [
            ...
            new("Mechi na ada",
                "Unapoingia mechi, dau lako linafungwa. Poti = dau zote mbili. Bobeta inachukua 25% ya poti. Mshindi anapata salio kwenye pochi."),
    ...
    private static readonly LegalDoc RulesEn = new(
        ...
        [
            new("How a match works",
                "You create or join a game, lock a stake, and play until there is a winner. The pot is both stakes. Bobeta keeps 25% as a platform fee. The winner gets the rest."),
            new("Makopa",
    ...
    private static readonly LegalDoc RulesFr = new(
        ...
        [
            new("Déroulement d'une partie",
                "Vous créez ou rejoignez une partie, bloquez une mise, et jouez jusqu'à un gagnant. Le pot = les deux mises. Bobeta garde 25 % de frais. Le gagnant reçoit le reste."),
            new("Makopa",
    ...
    private static readonly LegalDoc RulesKt = new(
        ...
        [
            new("Mutindu partie ke salama",
                "Sala to kota partie, zibisa mise, sakana tii na nani me longa. Pot = ba mises zole. Bobeta ke baka 25%. Nani me longa ke bakaka ya ntama."),
            new("Makopa",
    ...
    private static readonly LegalDoc RulesLn = new(
        ...
        [
            new("Ndenge partie esalama",
                "Sala to kota partie, ziba mise, sakana tii na oyo elongi. Pot = ba mises mibale. Bobeta ezwi 25%. Oyo elongi azwi oyo etikali."),
            new("Makopa",
    ...
    private static readonly LegalDoc RulesSw = new(
        ...
        [
            new("Jinsi mechi inavyofanya kazi",
                "Unda au jiunge, funga dau, cheza hadi mshindi. Poti = dau zote mbili. Bobeta inachukua 25%. Mshindi anapata salio."),
            new("Makopa",
