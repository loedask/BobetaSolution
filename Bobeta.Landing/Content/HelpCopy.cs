...
public static class HelpCopy
{
    ...
    [
        ...
        new("What games can I play?",
            "Makopa, Kopo, Ngola, Domino, Abbia, Nzengué, and Yoté. Open a game on the home page and tap History for background. Each match is one-vs-one for a stake you choose."),
    ...
    [
        ...
        new("Quels jeux puis-je jouer ?",
            "Makopa, Kopo, Ngola, Domino, Abbia, Nzengué et Yoté. Sur la page d'accueil, ouvrez un jeu et touchez Histoire pour le contexte. Chaque partie est un duel avec une mise que vous choisissez."),
    ...
    [
        ...
        new("Ba jeux nini nge lenda sakana?",
            "Makopa, Kopo, Ngola, Domino mpi Abbia mpi Nzengué mpi Yoté. Na page ya liboso, fina Histoire sambu na histoire. Ketesani kele duel ti mise nge me solula."),
    ...
    [
        ...
        new("Ba jeux nini nakoki kosakana?",
            "Makopa, Kopo, Ngola, Domino mpe Abbia mpe Nzengué mpe Yoté. Na lokasa ya liboso, finá Histoire mpo na historique. Mokano mokomoko ezali duel na mise oponi."),
    ...
    [
        ...
        new("Naweza kucheza michezo gani?",
            "Makopa, Kopo, Ngola, Domino, na Abbia, na Nzengué, na Yoté. Kwenye ukurasa wa kwanza, gusa Historia kwa historia. Kila mechi ni pambano la mtu mmoja dhidi ya mwingine kwa dau unalochagua."),
    ...
    private static readonly LegalDoc WhatIsEn = new(
        "What is Bobeta?",
        "Bobeta is a real-stakes platform on mobile money, built around Congolese and African table games. A short list you already know. Fast matches. Clear payouts.",
        [
            new("A short list, on purpose",
                "Big platforms stack hundreds of titles and leave you scrolling. Bobeta does the opposite. You get a small set of classic skill games such as Makopa, Kopo, Ngola, Domino, Nzengué, and Yoté, plus Abbia when you want a chance throw. The lineup starts in Congo and reaches across African games people already know. Pick one, stake, and play. No endless catalog to dig through."),
            ...
            new("Skill play, not a slot wall",
                "Most outcomes come from how you play. Deals, first turns, and Abbia throws use fair randomization in the game engines. There is no hidden odds board behind a thousand lookalike games."),
            new("How to start",
    ...
    private static readonly LegalDoc WhatIsFr = new(
        ...
        "Bobeta est une plateforme à enjeux réels via mobile money, bâtie autour de jeux de table congolais et africains. Une courte liste que vous connaissez déjà. Des parties rapides. Des paiements clairs.",
        [
            new("Une liste courte, volontairement",
                "Les grandes plateformes empilent des centaines de titres et vous font défiler. Bobeta fait l'inverse. Vous avez un petit set de jeux d'adresse classiques tels que Makopa, Kopo, Ngola, Domino, Nzengué et Yoté, plus Abbia pour un lancer de hasard. La ligne commence au Congo et s'ouvre aux jeux africains que les gens connaissent déjà. Choisissez, misez, jouez. Pas de catalogue infini."),
            ...
            new("De l'adresse, pas un mur de machines",
                "La plupart des résultats viennent du jeu. Les distributions, le premier tour et les lancers Abbia utilisent un tirage équitable dans les moteurs. Pas de cote cachée derrière mille jeux qui se ressemblent."),
    ...
    private static readonly LegalDoc WhatIsKt = new(
        "Bobeta kele nini?",
        "Bobeta kele plateforme ya ba enjeux ya kyeleka na mobile money, salama na ba jeux ya table ya Congo mpi ya Afrique. Liste ya kukusa ya ba jeux nge me zaba. Ba parties ya nswalu. Ba paiements ya polele.",
        [
            new("Liste ya kukusa, na lukanu",
                "Ba plateformes ya nene ke yika ba titres nkama mpi nge ke landa. Bobeta ke sala na nima. Nge ke zwaka set ya kukusa ya ba jeux ya adresse ya classique mutindu Makopa, Kopo, Ngola, Domino mpi Nzengué mpi Yoté, plus Abbia sambu na lancer ya hasard. Ligne ke bandaka na Congo mpi ke kanga ba jeux ya Afrique bantu me zaba. Sola, yika mise, sakana. Ve catalogue ya ndambu ve."),
            ...
            new("Adresse, ve mur ya ba machines",
                "Ba résultats mingi kele ya kusakana. Ba cartes, nani ke bandisa, mpi ba lancers Abbia ke solamaka na botondi. Ve cote ya kubumba nima ya ba jeux nkama."),
    ...
    private static readonly LegalDoc WhatIsLn = new(
        "Bobeta ezali nini?",
        "Bobeta ezali plateforme ya ba enjeux ya solo na mobile money, salemi na ba jeux ya table ya Congo mpe ya Afrique. Liste mokuse ya ba jeux oyebi. Ba parties ya mbangu. Ba paiements ya polele.",
        [
            new("Liste mokuse, na makanisi",
                "Ba plateformes ya monene ezali na ba titres nkama mpe ozali kolanda. Bobeta ezali kosala na nsima. Ozwi set mokuse ya ba jeux ya adresse ya classique lokola Makopa, Kopo, Ngola, Domino mpe Nzengué mpe Yoté, plus Abbia soki olingi lancer ya hasard. Ligne ebandaka na Congo mpe ekangaka ba jeux ya Afrique bato bayebi. Pona, tya mise, sakana. Ezali te catalogue ya seko."),
            ...
            new("Adresse, ezali te mur ya ba machines",
                "Ba résultats ebele ezali ya kosakana. Ba cartes, nani abandi, mpe ba lancers Abbia esalemaka na bolamu. Ezali te cote ya kobomba nsima ya ba jeux nkama."),
    ...
    private static readonly LegalDoc WhatIsSw = new(
        "Bobeta ni nini?",
        "Bobeta ni jukwaa la dau halisi kupitia mobile money, lililojengwa kuzunguka michezo ya meza ya Kongo na Afrika. Orodha fupi unayoijua. Mechi za haraka. Malipo wazi.",
        [
            new("Orodha fupi, kwa makusudi",
                "Majukwaa makubwa yanaweka mamia ya michezo na unakuwa unaskroli. Bobeta inafanya kinyume. Unapata seti ndogo ya michezo ya ustadi kama Makopa, Kopo, Ngola, Domino, Nzengué, na Yoté, pamoja na Abbia unapotaka tupa ya bahati. Orodha inaanza Kongo na inafikia michezo ya Afrika watu wanayoijua. Chagua, weka dau, cheza. Hakuna katalogi isiyoisha."),
            ...
            new("Ustadi, si ukuta wa slot",
                "Matokeo mengi yanatokana na uchezaji. Ugawaji, mwanzo, na tupa za Abbia hutumia bahati ya haki kwenye injini. Hakuna odds za siri nyuma ya michezo elfu zinazofanana."),
            new("Jinsi ya kuanza",
